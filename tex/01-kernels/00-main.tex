...
\item \points{1a} $K(x,z) = K_1(x,z) + K_2(x,z)$
\item \points{1b} $K(x,z) = K_1(x,z) - K_2(x,z)$
\item \points{1c} $K(x,z) = a K_1(x,z)$
\item \points{1d} $K(x,z) = -a K_1(x,z)$
\item \points{1e} $K(x,z) = K_1(x,z)K_2(x,z)$
\item \points{1f} $K(x,z) = f(x)f(z)$
\item \points{1g} $K(x,z) = K_3(\phi(x),\phi(z))$
\item \points{1h} $K(x,z) = p(K_1(x,z))$
